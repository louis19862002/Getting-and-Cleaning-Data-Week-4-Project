...
train_x_train and test_x_test, variables imported from features.txt:
...
For the column in train_y_train and test_y_test is the code for activity from "activity_labels.txt":
